...
class EncounterCreateTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->postJson("/api/compendia/$compendium->slug/encounters");
    ...
    public function test_it_returns_not_found_if_compendium_does_not_exist(): void
    {
        $response = $this->signedIn()
            ->postJson("/api/compendia/lalalala/encounters");
    ...
    public function test_it_returns_unauthorized_if_user_is_not_compendiums_creator(): void
    {
        ...
        $response = $this->actingAs($user)
            ->postJson("/api/compendia/$compendium->slug/encounters");
    ...
    public function test_it_returns_unprocessable_if_validation_failed($payload, $errors): void
    {
        ...
        $response = $this->asAdmin()
            ->postJson("/api/compendia/$compendium->slug/encounters", $payload);

        $response->assertUnprocessable();

        $response->assertInvalid($errors);

        $this->assertDatabaseEmpty('encounters');
    ...
    public function test_it_returns_successful_if_encounter_created(): void
    {
        $user = User::factory()->create();
        ...
        $encounter = Encounter::find($response->json('data')['id']);

        $user->refresh();

        $this->assertTrue($user->can('view', $encounter));
        $this->assertTrue($user->can('update', $encounter));
        $this->assertTrue($user->can('delete', $encounter));
    }
