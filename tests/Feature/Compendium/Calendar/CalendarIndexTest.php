...
class CalendarIndexTest extends TestCase
{
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->getJson("/api/compendia/$compendium->slug/calendars");
    ...
    public function test_it_returns_forbidden_if_user_hasnt_created_a_compendium(): void
    {
        ...
        $response = $this->actingAs($user)
            ->getJson("/api/compendia/$compendium->slug/calendars");
    ...
    public function test_it_returns_successful_if_calendars_returned(): void
    {
        $compendium = Compendium::factory()->create();

        $dontSeeCalendars = Calendar::factory(10)->create();
        $seeCalendars = Calendar::factory(10)
            ->for($compendium)
            ->create();
        ...
        $response->assertJson([
            'data' => $seeCalendars->map(fn(Calendar $calendar) => [
                'name' => $calendar->name,
    ...
    public function test_admin_can_see_other_user_compendiums(): void
    {
        ...
        $dontSeeCalendars = Calendar::factory(10)->create();
        $seeCalendars = Calendar::factory(10)->for($compendium)->create();
