...
class FactionIndexTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->getJson("/api/compendia/$compendium->slug/factions");
    ...
    public function test_it_returns_forbidden_if_user_hasnt_created_a_compendium(): void
    {
        ...
        $response = $this->actingAs($user)
            ->getJson("/api/compendia/$compendium->slug/factions");
    ...
    public function test_it_returns_successful_if_factions_returned(): void
    {
        $compendium = Compendium::factory()->create();

        $dontSeeFactions = Faction::factory(10)->create();
        $seeFactions = Faction::factory(10)
            ->for($compendium)
            ->create();
        ...
        $response->assertJson([
            'data' => $seeFactions->map(fn(Faction $faction) => [
                'name' => $faction->name,
    ...
    public function test_admin_can_see_other_user_compendiums(): void
    {
        ...
        $dontSeeFactions = Faction::factory(10)->create();
        $seeFactions = Faction::factory(10)->for($compendium)->create();
