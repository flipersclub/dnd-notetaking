...
class ReligionIndexTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->getJson("/api/compendia/$compendium->slug/religions");
    ...
    public function test_it_returns_forbidden_if_user_hasnt_created_a_compendium(): void
    {
        ...
        $response = $this->actingAs($user)
            ->getJson("/api/compendia/$compendium->slug/religions");
    ...
    public function test_it_returns_successful_if_religions_returned(): void
    {
        $compendium = Compendium::factory()->create();

        $dontSeeReligions = Religion::factory(10)->create();
        $seeReligions = Religion::factory(10)
            ->for($compendium)
            ->create();
        ...
        $response->assertJson([
            'data' => $seeReligions->map(fn(Religion $religion) => [
                'name' => $religion->name,
    ...
    public function test_admin_can_see_other_user_compendiums(): void
    {
        ...
        $dontSeeReligions = Religion::factory(10)->create();
        $seeReligions = Religion::factory(10)->for($compendium)->create();
