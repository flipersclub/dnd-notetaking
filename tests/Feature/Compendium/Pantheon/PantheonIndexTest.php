...
class PantheonIndexTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->getJson("/api/compendia/$compendium->slug/pantheons");
    ...
    public function test_it_returns_forbidden_if_user_hasnt_created_a_compendium(): void
    {
        ...
        $response = $this->actingAs($user)
            ->getJson("/api/compendia/$compendium->slug/pantheons");
    ...
    public function test_it_returns_successful_if_pantheons_returned(): void
    {
        $compendium = Compendium::factory()->create();

        $dontSeePantheons = Pantheon::factory(10)->create();
        $seePantheons = Pantheon::factory(10)
            ->for($compendium)
            ->create();
        ...
        $response->assertJson([
            'data' => $seePantheons->map(fn(Pantheon $pantheon) => [
                'name' => $pantheon->name,
    ...
    public function test_admin_can_see_other_user_compendiums(): void
    {
        ...
        $dontSeePantheons = Pantheon::factory(10)->create();
        $seePantheons = Pantheon::factory(10)->for($compendium)->create();
