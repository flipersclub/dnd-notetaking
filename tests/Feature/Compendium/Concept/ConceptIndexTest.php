...
class ConceptIndexTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->getJson("/api/compendia/$compendium->slug/concepts");
    ...
    public function test_it_returns_forbidden_if_user_hasnt_created_a_compendium(): void
    {
        ...
        $response = $this->actingAs($user)
            ->getJson("/api/compendia/$compendium->slug/concepts");
    ...
    public function test_it_returns_successful_if_concepts_returned(): void
    {
        $compendium = Compendium::factory()->create();

        $dontSeeConcepts = Concept::factory(10)->create();
        $seeConcepts = Concept::factory(10)
            ->for($compendium)
            ->create();
        ...
        $response->assertJson([
            'data' => $seeConcepts->map(fn(Concept $concept) => [
                'name' => $concept->name,
    ...
    public function test_admin_can_see_other_user_compendiums(): void
    {
        ...
        $dontSeeConcepts = Concept::factory(10)->create();
        $seeConcepts = Concept::factory(10)->for($compendium)->create();
