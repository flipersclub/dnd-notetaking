...
class ItemCreateTest extends TestCase
{
    ...
    public function test_it_returns_unauthorized_if_user_not_logged_in(): void
    {
        ...
        $response = $this->postJson("/api/compendia/$compendium->slug/items");
    ...
    public function test_it_returns_not_found_if_compendium_does_not_exist(): void
    {
        $response = $this->signedIn()
            ->postJson("/api/compendia/lalalala/items");
    ...
    public function test_it_returns_unauthorized_if_user_is_not_compendiums_creator(): void
    {
        ...
        $response = $this->actingAs($user)
            ->postJson("/api/compendia/$compendium->slug/items");
    ...
    public function test_it_returns_unprocessable_if_validation_failed($payload, $errors): void
    {
        ...
        $response = $this->asAdmin()
            ->postJson("/api/compendia/$compendium->slug/items", $payload);
    ...
    public static function validationDataProvider()
    {
        return [
            ...
            'name longer than 255 items' => [['name' => Str::random(256)], ['name' => 'The name field must not be greater than 255 characters.']],
            'content not a string' => [['content' => ['an', 'array']], ['content' => 'The content field must be a string.']],
            'content longer than 65535 items' => [['content' => Str::random(65536)], ['content' => 'The content field must not be greater than 65535 characters.'],],
        ];
    }

    public function test_it_returns_successful_if_item_created(): void
    {
        $user = User::factory()->create();
